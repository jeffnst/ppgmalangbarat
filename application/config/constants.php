...
define('BASE_URL', 'http://localhost/standar_ci/public/sigrus/');
define('BACKEND_STATIC_FILES', BASE_URL . 'assets/statics/backend/');// WITH URL
define('BACKEND_IMAGE_FOLDER', BASE_URL . 'assets/images/backend/'); // WITH URL
define('IMAGE_PATH', 'assets/images/backend/');
