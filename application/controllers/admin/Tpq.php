...
class tpq extends admin
{
    ...
    {
        $this->load->view('admin/tpq/include', $this->data);
    ...
    public function data()
    {
        ...
        $this->display('admin/tpq/data', $this->data);
    }
    ...
    public function detail()
    {
        ...
        if ($get_data_tpq["results"][0] != "") {
            ...
            $dir_logo = IMAGE_PATH . 'tpq/' . $id_tpq . '/logo/' . $logo;
            $dir_cover = IMAGE_PATH . 'tpq/' . $id_tpq . '/cover/' . $cover;
            $logo_dir_check = check_if_empty($logo, $dir_logo);
            // print_r($dir_logo);exit();
            ...
            $get_data_tpq['results'][0]->logo = base_url().$logo_dir_check;
            $get_data_tpq['results'][0]->cover = base_url().$cover_dir_check;
            ...
            $this->display("admin/tpq/detail", $this->data);
        } else {
            redirect('/admin/404');
        }
    }
    ...
    public function add()
    {
        ...
        $this->display('admin/tpq/add', $this->data);
    }
